...
PriorClockInResponseModel priorClockInResponseModelFromJson(String str) =>
    PriorClockInResponseModel.fromJson(json.decode(str));

String priorClockInResponseModelToJson(PriorClockInResponseModel data) =>
...
class PriorClockInResponseModel {
  ...
  factory PriorClockInResponseModel.fromJson(Map<String, dynamic> json) =>
      PriorClockInResponseModel(
        error: json["error"],
        message: json["message"] ?? '',
        data: json["data"] != null
            ? List<PriorClockInModel>.from(
                json["data"].map((x) => PriorClockInModel.fromJson(x)))
            : [],
...
class PriorClockInModel {
  ...
  factory PriorClockInModel.fromJson(Map<String, dynamic> json) =>
      PriorClockInModel(
        id: json["id"],
        schedulePeriod: json["schedulePeriod"] ?? '',
        accountId: json["accountId"],
