...
//
//     final listHouseForDcAddShiftModel = listHouseForDcAddShiftModelFromJson(jsonString);

import 'dart:convert';

ListHouseForDcAddShiftModel listHouseForDcAddShiftModelFromJson(String str) => ListHouseForDcAddShiftModel.fromJson(json.decode(str));

String listHouseForDcAddShiftModelToJson(ListHouseForDcAddShiftModel data) => json.encode(data.toJson());

class ListHouseForDcAddShiftModel {
  bool? success;
  String? message;
  List<HouseForDcAddShift>? data;
  int? currentPage;
  dynamic nextPage;
  dynamic previouPage;
  int? pageSize;
  ...
  factory ListHouseForDcAddShiftModel.fromJson(Map<String, dynamic> json) => ListHouseForDcAddShiftModel(
    success: json["success"],
    message: json["message"],
    data: json["data"] == null ? [] : List<HouseForDcAddShift>.from(json["data"]!.map((x) => HouseForDcAddShift.fromJson(x))),
...
class HouseForDcAddShift {
  ...
  factory HouseForDcAddShift.fromJson(Map<String, dynamic> json) => HouseForDcAddShift(
    id: json["id"],
