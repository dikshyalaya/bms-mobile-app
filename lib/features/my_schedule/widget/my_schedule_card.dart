  ...
  Widget build(BuildContext context) {
    return  Card(
      ...
      child: Column(
        ...
        children: [const MyScheduleCardHeader(),const SizedBox(height: 11,),
        Padding(
          padding: const EdgeInsetsDirectional.symmetric(horizontal: 19),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text("Adapt - Brooklyn IRA (Apt 6N)",style: TextStyle(
                  color: Color(0xff1B1B1B),
                  fontSize: 13,fontWeight: FontWeight.w500
              ),),
              const SizedBox(height: 6,),
              const Text("175 Willoughby St,Brooklyn,NY 11201",style: TextStyle(
                  color: Color(0xff1B1B1B),
