                          ...
                          builder: (context) =>     Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Expanded(child: ListView.separated(itemBuilder: (context,index)=> ShiftAvailabilityCard(scheduleCardModel: availableShiftsForDcModel.data![index],), separatorBuilder: (context,index)=>const SizedBox(height: 9,), itemCount: availableShiftsForDcModel.data?.length??0)),
