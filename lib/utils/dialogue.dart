...
class DialogueUtils {
  ...
  static Text buildText(BuildContext context, String text) {
    return Text(
      text,
      style: TextStyle(
        color: Colors.black,
                  ...
                  children: [
                    Column(children: [
                      Image.asset(
                        ...
                        width: 0.12.h(context),
                      ),
                      SizedBox(height: 0.018.h(context)),
                      Text(
                        userName,
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(height: 0.016.h(context)),
                        GestureDetector(
                          onTap: () {
                            authProvider.logOut();
  ...
  static Future<String?> selectSchedulePeriodDialogue(
      {required BuildContext context,
      required List<SchedulePeriod> schedulePeriods}) async {
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          color: Color(0xffD9D9D9)),
                      alignment: Alignment.center,
                      child: buildText(context, "Change Password"),
                    ),
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              buildText(context, 'New Password'),
                              SizedBox(
                                width: 0.5.w(context),
                          ...
                          Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              buildText(context, 'Confirm Password'),
                              SizedBox(
                                width: 0.5.w(context),
                                child: PWChangeTextFormField(
                                  onChangedInput: (String val) {
